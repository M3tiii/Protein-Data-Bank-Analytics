...
## Usuniêcie wierszy zawieraj¹cych wybrane wartoœci res_name
...
## Najpopularniejsze wartoœci res_name
...
ggplotly(ggplot(
  ...
  xlab("liczba atomów") + ylab("liczba wyst¹pieñ"))
```
...
ggplotly(ggplot(
  ...
  xlab("liczba elektronów") + ylab("liczba wyst¹pieñ"))
```

## Klasy z najwiêksz¹ niezgodnoœci¹ liczby atomów i  liczby elektronów
